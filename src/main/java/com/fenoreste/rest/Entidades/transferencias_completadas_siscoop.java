...
public class transferencias_completadas_siscoop implements Serializable {
  ...
  public transferencias_completadas_siscoop(Integer id, String customerId, String tipotransferencia, String cuentaorigen, String cuentadestino, Double monto, String comentario1, String comentario2, Date fechaejecucion, String tipoejecucion, boolean estatus) {
    this.id = id;
