    ...
    Security scr=new Security();
     ...
     try{
      ...
      return Response.status(Response.Status.BAD_REQUEST).entity(e.getMessage()).build();
       ...
       try {
           validateMonetaryInstructionDTO dto=dao.validateMonetaryInstruction(customerId, tipoTranferencia,
                   cuentaOrigen, cuentaDestino, monto, comentario, propCuenta,fechaEjecucion, tipoEjecucion);
