...
public class transferencias_completadas_siscoop implements Serializable {
  ...
  public transferencias_completadas_siscoop(Integer id, String customerId, String tipotransferencia, String cuentaorigen, String cuentadestino, Integer monto, String comentario1, String comentario2, Date fechaejecucion, String tipoejecucion, boolean estatus) {
    this.id = id;
  ...
  public String toString() {
    return "transferencias_completadas_siscoop{id=" + this.id + ", customerId=" + this.customerId + ", tipotransferencia=" + this.tipotransferencia + ", cuentaorigen=" + this.cuentaorigen + ", cuentadestino=" + this.cuentadestino + ", monto=" + this.monto + ", comentario1=" + this.comentario1 + ", comentario2=" + this.comentario2 + ", fechaejecucion=" + this.fechaejecucion + ", tipoejecucion=" + this.tipoejecucion + ", estatus=" + this.estatus + '}';
  }
}